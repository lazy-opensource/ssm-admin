...
public class KissoDefaultHandler implements SSOHandlerInterceptor {
	private static com.baomidou.kisso.web.handler.KissoDefaultHandler handler;

	/**
	 * new 当前对象
	 */
	public static com.baomidou.kisso.web.handler.KissoDefaultHandler getInstance() {
		if (handler == null) {
			handler = new com.baomidou.kisso.web.handler.KissoDefaultHandler();
		}
		return handler;
	}
