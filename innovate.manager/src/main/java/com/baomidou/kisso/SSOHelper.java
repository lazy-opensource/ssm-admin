...
public class SSOHelper {
	 ...
	 * 					销毁当前 JSESSIONID
	 */
	public static void setSSOCookie(HttpServletRequest request, HttpServletResponse response, com.baomidou.kisso.Token token, boolean invalidate ) {
		if(invalidate){
	...
	public static <T extends com.baomidou.kisso.Token> T getToken(HttpServletRequest request ) {
