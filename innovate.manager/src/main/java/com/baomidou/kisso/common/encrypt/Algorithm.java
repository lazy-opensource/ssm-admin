...
public enum Algorithm {
	...
	public static com.baomidou.kisso.common.encrypt.Algorithm convert(String encryptAlgorithm) {
		com.baomidou.kisso.common.encrypt.Algorithm algorithm = RC4;
		if (null != encryptAlgorithm) {
			com.baomidou.kisso.common.encrypt.Algorithm[] algs = values();
			for (com.baomidou.kisso.common.encrypt.Algorithm alg : algs) {
