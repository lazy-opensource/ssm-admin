...
public class SaltEncoder {
	...
	public static String md5SaltEncode( String salt, String rawText ) {
		return new com.baomidou.kisso.common.encrypt.SaltEncoder(salt, com.baomidou.kisso.common.encrypt.MD5.ALGORITHM).encode(rawText);
	}
	...
	public static boolean md5SaltValid( String salt, String encodeText, String rawText ) {
		return new com.baomidou.kisso.common.encrypt.SaltEncoder(salt, MD5.ALGORITHM).isValid(encodeText, rawText);
	}
