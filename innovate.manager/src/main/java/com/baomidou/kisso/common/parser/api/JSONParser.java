...
public class JSONParser {
	 ...
	 */
	public static com.baomidou.kisso.common.parser.api.EncryptMsg extract(String jsontext ) throws AESException {
		try {
			SSOConfig config = SSOConfig.getInstance();
			return config.getParser().parseObject(jsontext, com.baomidou.kisso.common.parser.api.EncryptMsg.class);
		} catch (Exception e) {
